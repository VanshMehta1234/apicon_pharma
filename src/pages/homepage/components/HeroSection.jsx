      ...
      <div className="w-full px-5 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            {/* Content Section */}
            <div className="text-center lg:text-left fade-in-up reveal">
              <div className="mb-6">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6 leading-tight text-center lg:text-left">
                <span className="text-gradient">Precision Molecules</span> for Life-Saving Treatments
              </h1>
              
              <p className="text-base sm:text-lg md:text-xl leading-relaxed sm:leading-8 text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-6 sm:mb-8">
                <button 
                  ...
                  className="inline-flex items-center justify-center px-4 py-2 sm:px-6 sm:py-3 bg-conversion hover:bg-conversion/90 text-conversion-foreground rounded-lg font-semibold shadow-sm hover:shadow-md transition-all duration-300 w-full sm:w-auto text-xs sm:text-sm"
                >
                ...
                <button 
                  ...
                  className="inline-flex items-center justify-center px-4 py-2 sm:px-6 sm:py-3 border border-border hover:bg-accent text-foreground rounded-lg font-semibold shadow-sm hover:shadow-md transition-all duration-300 w-full sm:w-auto text-xs sm:text-sm"
                >
              ...
              {/* Trust badges */}
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 reveal" style={{ transitionDelay: '120ms' }}>
              ...
              <div className="bg-card/80 backdrop-blur-sm border border-border rounded-xl p-4 sm:p-6 shadow-lg reveal" style={{ transitionDelay: '200ms' }}>
            ...
            {/* Lab Image */}
            <div className="relative mt-6 lg:mt-0 reveal" style={{ transitionDelay: '160ms' }}>
